...
INGREDIENT_NAME_FIELD_LENGTH = 32
MEASUREMENT_UNIT_FIELD_LENGTH = 64
RECIPE_NAME_FIELD_LENGTH = 256
EMAIL_NAME_FIELD_LENGTH = 254
...
COOKING_TIME_MESSAGE_ERROR = (
    f'Время приготовления варьируется от {MIN_MEANING} '
    f'до {MAX_MEANING} минут'
)
AMOUNT_MESSAGE_ERROR = (
    f'Количество варьируется от {MIN_MEANING} '
    f'до {MAX_MEANING} минут'
)
